...
export const Home_MapsList = (props) => {
    ...
    const OpenFormForPrivateMap = () => {
        let type = 'private';
        props.openFormAddMap(type);    
    }

    const OpenFormForPublicMap = () => {
        let type = 'public';
        props.openFormAddMap(type);    
    }
    ...
    return(       
        <div className='home-container__maps-grid'>
            <h3 className='maps-grid__title'>Приватные карты</h3>
            ...
            <div className='maps-grid__container'>
                ...
                <div className='map-card__button-create' onClick={OpenFormForPrivateMap}>
            ...
            <div className='maps-grid__container'>
                ...
                <div className='map-card__button-create' onClick={OpenFormForPublicMap}>
                    <svg className='map-card__button-create__icon' width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.6607 6.16071H9.10714C8.95922 6.16071 8.83929 6.04078 8.83929 5.89286V1.33929C8.83929 0.59967 8.23962 0 7.5 0C6.76038 0 6.16071 0.59967 6.16071 1.33929V5.89286C6.16071 6.04078 6.04078 6.16071 5.89286 6.16071H1.33929C0.59967 6.16071 0 6.76038 0 7.5C0 8.23962 0.59967 8.83929 1.33929 8.83929H5.89286C6.04078 8.83929 6.16071 8.95922 6.16071 9.10714V13.6607C6.16071 14.4003 6.76038 15 7.5 15C8.23962 15 8.83929 14.4003 8.83929 13.6607V9.10714C8.83929 8.95922 8.95922 8.83929 9.10714 8.83929H13.6607C14.4003 8.83929 15 8.23962 15 7.5C15 6.76038 14.4003 6.16071 13.6607 6.16071Z" fill="white"/>
                    </svg>
                </div>
